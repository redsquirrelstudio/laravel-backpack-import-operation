...
@section('content')
    ...
    <div class="row">
        <div class="{{ $crud->getCreateContentClass() }}">
            ...
            <form method="post"
                  action="{{ url($crud->route.'/import/'.$import_id.'/confirm') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body py-2 px-0">
                                            <p class="font-sm font-weight-bold text-muted text-uppercase text-center m-0">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <div class="card" style="height: 100%;">
                                                <div class="card-body d-flex flex-column justify-content-center py-2 px-3">
                                        ...
                                        <div class="col-md-2">
                                            <div class="card" style="height: 100%;">
                                                <div class="card-body d-flex flex-column align-items-center justify-content-center py-2 px-3">
                                                    <i class="las la-arrow-right font-5xl text-muted"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
